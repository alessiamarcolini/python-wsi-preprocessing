...
# BASE_DIR = "/Users/nicole/Desktop/"
# DATASET_NAME = "data_wsi_cima/"
IMG_EXT = "png"
# PROCESSED_DIR = os.path.join(BASE_DIR, DATASET_NAME, "processed")
# THUMBNAIL_DIR = os.path.join(PROCESSED_DIR, "thumbnail_" + IMG_EXT)
# WSI_DIR = os.path.join(BASE_DIR, DATASET_NAME)
THUMBNAIL_SIZE = 300
...
class Slide(object):
    ...
    def save_scaled_image(self):
        ...
        print(f"Saving scaled image to: {self.scaled_image_path}")
    ...
    def _breadcumb(self, directory_path):
        ...
        Returns
        -------
        final_path: str, a real anc complete path starting from the dir path
    ...
    def _resample(self):
        ...
        # print(f'best level for downsample: {level}')
    ...
    @property
    def _resampled_dimensions(self):
    ...
    def _wsi(self):
        ...
        try:
            ...
            slide = None
            print("openslide slide error")
        except FileNotFoundError:
            print(f"file {self._wsi_path} not found")
            slide = None
        return slide

    @property
    def _wsi_extension(self):
